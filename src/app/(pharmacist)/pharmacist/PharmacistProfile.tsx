...
import { User, Mail, Phone, Calendar, MapPin, CreditCard as Edit, Save, Camera, Shield, Award, Clock, Pill } from 'lucide-react';

const PharmacistProfile: React.FC = () => {
  const [isEditing, setIsEditing] = useState(false);
  const [profileData, setProfileData] = useState({
    name: 'Dr. Priya Patel',
    email: 'priya.patel@medicarehosp.com',
    phone: '+91 9876543210',
    employeeId: 'PHR001',
    department: 'Pharmacy',
  ...
  const stats = [
    { label: 'Medicines Issued', value: '3,247', icon: Pill, color: 'blue' },
    { label: 'Years of Experience', value: '10', icon: Award, color: 'green' },
    { label: 'Prescriptions Processed', value: '2,156', icon: Shield, color: 'purple' },
    { label: 'Accuracy Rate', value: '99.8%', icon: Clock, color: 'emerald' }
  ];
            ...
            <div className="p-6 text-center">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div>
                    <p className="text-2xl font-bold text-purple-600">{profileData.experience}</p>
