...
const RecentPrescriptions: React.FC<PrescriptionProps> = ({student_id}) => {
  ...
  const fetchPrescriptionHistory = async () => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/prescriptions/student/${student_id}`, {
        method: 'GET',
        headers: {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="bg-white rounded-xl shadow-sm border border-gray-200">
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-gray-600 mt-2">View and download your prescription records</p>
        </div>
                    ...
                    <div className="lg:col-span-2">
                      <div className="space-y-3">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            {prescription.notes || prescription.doctorNotes || 'No notes available'}
                          </p>
                        </div>
