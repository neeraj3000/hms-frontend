  ...
  const downloadLabReport = async (
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/lab-reports/${reportId}/download`,
        {
          method: "GET",
          // headers: {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4 sm:p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-3 sm:mb-4 flex items-center flex-wrap">
                    ...
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 flex items-center">
                      ...
                      >
                        <path
                          ...
                          d="M9 19V6a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v13m-6 0h6"
                        />
                      </svg>
                      Doctor Audio
                    </h3>
                    ...
                    <div className="bg-gray-50 rounded-lg p-6">
                      ...
                      <div className="space-y-3">
                        {prescription.medicines.map(
                          (medicine: MedicineEntry, index: number) => (
                            <div
                              key={index}
                        ...
                        <div className="bg-white rounded-lg border p-4 flex flex-col">
                          ...
                          <div className="flex justify-between items-center flex-wrap gap-2">
                            ...
                            <div className="flex gap-2">
                              <button
                                onClick={() =>
                                  openLightbox(prescription.nurse_image_url)
                                }
                                className="flex items-center space-x-1 px-3 py-1 bg-gray-100 hover:bg-gray-200 text-gray-800 text-sm rounded-lg transition"
                              >
                        ...
                        <div className="bg-white rounded-lg border p-4 flex flex-col">
                          ...
                          <div className="flex justify-between items-center flex-wrap gap-2">
                            ...
                            <div className="flex gap-2">
                              <button
                                onClick={() =>
                                  openLightbox(prescription.doctor_image_url)
                                }
                                className="flex items-center space-x-1 px-3 py-1 bg-gray-100 hover:bg-gray-200 text-gray-800 text-sm rounded-lg transition"
                              >
                                <Eye className="w-4 h-4" />
